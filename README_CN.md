...
**支持工具**: Claude Code · OpenClaw · OpenCode · Cursor · Windsurf · Gemini CLI · Codex CLI — 以及任何支持 system prompt 的 AI 编程助手。
...
支持: `claude`, `openclaw`, `opencode`, `cursor`, `windsurf`, `gemini`, `codex`, 或 `all`。
...
**Q: 支持哪些 AI 工具？**
七种工具原生安装支持：**Claude Code**、**OpenClaw**、**OpenCode**（oh-my-opencode）、**Cursor**、**Windsurf**、**Gemini CLI** 和 **Codex CLI**。运行 `./scripts/install.sh --tool <工具名>` 自动转换为对应格式安装。其他支持 Markdown 规则文件的工具也可手动配置。
